module instMem(inst, pcOut);
    ...
    reg [7:0] instMem[16:0]; //instruction memory
    ...
    begin
        ...
        instMem[1] <= 8'b10010110; //addi inst
        instMem[2] <= 8'b10110010; //sw inst
        instMem[3] <= 8'b11010011; //lw1 inst
        instMem[4] <= 8'b11010010; //lw2 inst
        instMem[5] <= 8'b11110011; //sll inst
        instMem[6] <= 8'b10010000; //addi inst
    end
    always@(pcOut)
    begin
        inst <= instMem[pcOut];
