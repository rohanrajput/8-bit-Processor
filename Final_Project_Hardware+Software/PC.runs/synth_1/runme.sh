...
HD_PWD='C:/Xilinx/Projects/PC3/PC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainFile.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainFile.tcl
