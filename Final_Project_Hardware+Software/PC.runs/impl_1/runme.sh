...
HD_PWD='C:/Xilinx/Projects/PC3/PC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mainFile.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mainFile.tcl -notrace
