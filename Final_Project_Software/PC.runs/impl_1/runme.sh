...
HD_PWD='C:/Xilinx/Projects/PC/PC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cuSimTest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cuSimTest.tcl -notrace
