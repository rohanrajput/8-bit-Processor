...
HD_PWD='C:/Xilinx/Projects/PC/PC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cuSimTest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cuSimTest.tcl
